...
// DeleteBackupByName deletes an ARK backup by name
func (c *Client) DeleteBackupByName(name string) (err error) {

	err = c.Client.Ark().Backups(c.Namespace).Delete(name, &metav1.DeleteOptions{})
